...
chsource = Redis:get(Fast..'chsource') or "otlop12"
devsource = Redis:get(Fast..'devsource') or "FPFFG"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,1593178008,929431022}
...
if text == 'كانسل' and tonumber(senderr) == tonumber(1593178008) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(1593178008) then
...
if tonumber(senderr) == 1593178008 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 929431022 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(1593178008) then
...
if text == 'محمود' or text == 'حودا' or text == 'محموض'  then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(1593178008) then
local txx = "\n"
...
if text == (Redis:get(Fast.."Name:Bot") or "فاست") then
local NamesBot = (Redis:get(Fast.."Name:Bot") or "فاست")
local NameBots = {
"قلب "..NamesBot.. "",
